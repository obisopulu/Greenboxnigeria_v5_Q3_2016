...
<form action='pjhygfyfjhb.php' method='get'>
<table width="100%"><tr><td>
<?php 
$counter = 1;
while($row = mysql_fetch_array($sql2))
	{extract($row);
		if ($counter == '5') {echo "<table style='background:url(images/"; if (!file_exists("images/mobblogsponsor5.jpg")){echo 'bg.jpg';} else{echo 'mobblogsponsor5.jpg';} echo ") center;' height='200px' width='100%'><tr><td></td></tr></table>";}
echo "<table width='100%' style='margin:10px 0px; padding:5px 5px;'><tr class='blog' bgcolor='#222' height='400px'><td style='padding:0px 15px;' width='90%'>
...
</tr><tr><td bgcolor='#555' style='background:url(activitiesimg/$activityPic) center no-repeat; background-size:cover; height:20px;' colspan='2'></td></tr></table>";
		if ($counter == '1') {echo "<table style='background:url(images/"; if (!file_exists("images/mobblogsponsor1.jpg")){echo 'bg.jpg';} else{echo 'mobblogsponsor1.jpg';} echo ") center;' height='200px' width='100%'><tr><td></td></tr></table>";}
$counter++;}
?>
