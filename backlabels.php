...
<table align='center' width='2000px'>
	<tr  bgcolor='#555' height='11px'>
    	...
    	<td style='padding:5px;'>label ID</td>
        <td style='padding:5px;'>labelName</td>
        <td style='padding:5px;'>label Pic</td>
        <td style='padding:5px;'>labelOwner</td>
        <td style='padding:5px;'>Year Founded</td>
        <td style='padding:5px;'>labelHistory</td>
        <td style='padding:5px;'>labelArtists</td>
        <td style='padding:5px;'>labelProducers</td>
...
while($row = mysql_fetch_array($sql2))
	{extract($row);
    	...
    	<td style="padding:5px;"><?php echo trim($labelID)?></td>
        <td style="padding:5px;"><?php echo trim($labelName)?></td>
        <td style="padding:5px;"><?php if (trim($labelPic) != '') echo 'Yes';else echo 'No'?></td>
        <td style="padding:5px;"><?php echo trim($labelOwner)?></td>
        <td style="padding:5px;"><?php echo trim($labelIntro)?></td>
        <td style="padding:5px;"><?php echo substr_replace(trim($labelHistory),'',30)?></td>
        <td style="padding:5px;"><?php echo trim($labelArtists)?></td>
        <td style="padding:5px;"><?php echo trim($labelProducers)?></td>
