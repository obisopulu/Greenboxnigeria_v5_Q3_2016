...
<form action="vghdtywtrey.php" method="GET">
...
while($row = mysql_fetch_array($sql2))
	{ 
	extract($row);
	if ($counter == '5') {echo "<tr style='background:url(images/"; if (!file_exists("images/mobpeoplesponsor5.jpg")){echo 'bg.jpg';} else{echo 'mobpeoplesponsor5.jpg';} echo ") center;' height='200px' width='100%'><td></td></tr>";}
		...
		<tr valign='middle'><td align='center'><span id='name'>$personStageName</span><br/><br/></td></tr>";
			if ($counter == '1') {echo "<tr style='background:url(images/"; if (!file_exists("images/mobpeoplesponsor1.jpg")){echo 'bg.jpg';} else{echo 'mobpeoplesponsor1.jpg';} echo ") center;' height='200px' width='100%'><td></td></tr>";}
	$counter++;}?>
</form>
</table>

<table align="center" width='100%'>
<tr><td align="center"><?php echo $paginationDisplay;?></td></tr>
</table>
